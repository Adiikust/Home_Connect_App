...
class AdminInquiryViewScreen extends StatelessWidget {
  final AdminOrderDetailsModel modelData;
  int modelIndex;
  AdminInquiryViewScreen(
      {Key? key, required this.modelIndex, required this.modelData})
      : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              BuildRow(
                  title: "Status",
                  subTitle: modelData.data![modelIndex].status.toString(),
              ...
              ListView.builder(
                ...
                shrinkWrap: true,
                itemCount: modelData.data![modelIndex].vendorTypeName!.length,
              ...
              BuildRow(
                title: "Images",
                subTitle: modelData.data![modelIndex].image!.length.toString(),
              ),
              BuildSizeBox(
                height: Get.height * ScreenSizes.SCREEN_SIZE_2,
              ),
              ...
              BuildRow(
                title: "Videos",
                subTitle: modelData.data![modelIndex].video!.length.toString(),
              ),
              BuildSizeBox(
                height: Get.height * ScreenSizes.SCREEN_SIZE_2,
              ),
