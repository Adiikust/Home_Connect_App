...
class VendorStepsVideosScreen extends StatelessWidget {
  final List vendorStepsVideos;
  VendorStepsVideosScreen({Key? key, required this.vendorStepsVideos})
      : super(key: key);
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  BuildSizeBox(height: Get.height * ScreenSizes.SCREEN_SIZE_1),
                  vendorStepsVideos.isNotEmpty
                      ? Expanded(
                          child: ListView.builder(
                            itemCount: vendorStepsVideos.length,
                                      ...
                                      onTap: () {
                                        Get.to(
                                          VendorVideoPlayScreen(
                                            videoFile: vendorStepsVideos[index]
                                                .toString(),
                                          ),
                                        );
                                      },
