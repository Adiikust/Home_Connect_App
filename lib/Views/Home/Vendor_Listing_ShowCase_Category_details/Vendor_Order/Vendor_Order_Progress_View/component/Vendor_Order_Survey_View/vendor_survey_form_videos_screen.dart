...
class VendorSurveyFormVideosScreen extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  vendorOrderDataModel
                          .data[vendorOrderDataIndex].survey.video.isNotEmpty
                      ? Expanded(
                          child: ListView.builder(
                            itemCount: vendorOrderDataModel
                                .data[vendorOrderDataIndex].survey.video.length,
