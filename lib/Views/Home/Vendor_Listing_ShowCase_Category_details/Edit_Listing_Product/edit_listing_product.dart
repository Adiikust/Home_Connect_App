...
import 'package:vendor_app/Views/Home/Vendor_Listing_ShowCase_Category_details/Edit_Listing_Product/editListingService.dart';
...
class EditListingProduct extends StatefulWidget {
  String productTitle,
      productPrice,
      productDescription,
      productID,
  ...
  @override
  State<EditListingProduct> createState() => _EditListingProductState();
}

class _EditListingProductState extends State<EditListingProduct> {
  List<File> imageFile = [];
  final picker = ImagePicker();

  final _formKey = GlobalKey<FormState>();
  final EditListingFormService editListingFormService =
      EditListingFormService();
                    ...
                    TextBottun(
                      ...
                      clickCallback: () {
                        ...
                        if (_formKey.currentState!.validate()) {
                          ...
                          editListingFormService.editListingFormData(
