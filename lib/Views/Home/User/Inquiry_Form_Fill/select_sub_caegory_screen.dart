...
import 'package:vendor_app/Views/Home/User/Inquiry_Form_Fill/select_vendor_types_screen.dart';
...
class SelectSubCategoriesScreen extends StatelessWidget {
  String title;
  SelectSubCategoriesScreen({Key? key, required this.title}) : super(key: key);
                          ...
                          return InkWell(
                            onTap: () {
                              ...
                              Overseer.inquirySubCategoriesID =
                                  modelData.data[index].id.toString();
                              print(
                                  "Sub catalogers ${Overseer.inquirySubCategoriesID.toString()}");
                              Get.to(SelectVendorTypeScreen(
